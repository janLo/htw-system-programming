...
\subsection{check\_input}\label{fn:check_input}
...
\subsection{read\_remote}\label{read_remote}
...
\subsection{write\_remote}\label{write_remote}
...
\subsection{free\_protocol}\label{free_protocol}
...
\subsection{try\_command}\label{try_command}
