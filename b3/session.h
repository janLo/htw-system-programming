...
#define USER_MSG_RCPT_OK	"%s, %s seems to be a good recipient\r\n"
#define USER_MSG_RCPT_FAIL	"%s, %s is bad, please try again\r\n"
#define USER_MSG_SUBJECT_ASK	"Please specify the subject of the Mail\r\n"
#define USER_MSG_SUBJECT_OK	"%s, %s seems to be a good subject\r\n"
#define USER_MSG_SUBJECT_FAIL	"%s, %s is a bad Subject, please try again\r\n"
